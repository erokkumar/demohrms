...
const API_URL = "https://localhost:5000/api/employee_attendance"; // Replace with your real API
...
, []);
    ...
    const fetchDataEmployee = async () => {
      try {
        const response = await fetch("https://localhost:5000/api/employee_attendance");
        if (!response.ok) throw new Error("Failed to fetch data");
